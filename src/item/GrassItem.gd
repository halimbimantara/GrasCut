...
#func _ready():
#	tweenNode.interpolate_property($GrassScatter/Flower,"visible",false,true,2,Tween.TRANS_LINEAR,Tween.EASE_OUT)
#	tweenNode.start()
...
func _onPopFlower(caller):
	tweenNode.interpolate_property($GrassScatter/Flower,"visible",false,true,0.1,Tween.TRANS_LINEAR,Tween.EASE_OUT)
	tweenNode.start()
	tweenNode.interpolate_property($GrassScatter/Flower,"scale_modifier",1,7,0.1,Tween.TRANS_LINEAR,Tween.EASE_OUT)
	tweenNode.start()
...
func _on_Tween_tween_all_completed():
	tweenNode2.interpolate_property($GrassScatter/Flower,"scale_modifier",1,6,2,Tween.TRANS_ELASTIC,Tween.EASE_OUT)
	tweenNode2.start()
	print("pomp")
